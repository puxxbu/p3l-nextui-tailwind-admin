...
import { mdiChartBar, mdiGraph } from '@mdi/js';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const showDataMaster =
    auth.role.id_role === 1002 || auth.role.id_role === 1001;

  const showLaporan = auth.role.id_role === 1004 || auth.role.id_role === 1005;
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <h1 className="pl-2 text-xl text-white">Grand Atma Hotel Admin</h1>
        </NavLink>
        ...
        <nav className="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={pathname === '/fo' || pathname.includes('fo')}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
